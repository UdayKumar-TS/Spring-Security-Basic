...
public class SecurityConfig {
    ...
    /*
        to authenticate all the endpoints.
    ...
    public UserDetailsService userDetailsService(){
        UserDetails user= User.builder().username("Uday").password(passwordEncoder().encode("Uday")).roles("User").build();
        UserDetails admin=User.builder().username("Ram").password(passwordEncoder().encode("Ram")).roles("Admin").build();
